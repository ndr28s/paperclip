    ...
    return {
      fields: [
        ...
        },
        {
          ...
          type: "number",
          default: 10,
          hint: "Seconds to wait after SIGTERM before sending SIGKILL.",
          group: "Advanced",
        },
        {
          key: "verbose",
        ...
        },
        {
          ...
          type: "textarea",
          hint: "Custom prompt template. Available variables: {{agentId}}, {{agentName}}, {{companyId}}, {{companyName}}, {{runId}}, {{taskId}}, {{taskTitle}}, {{taskBody}}, {{projectName}}. Leave blank for the default template.",
          group: "Advanced",
        },
      ],
    };
