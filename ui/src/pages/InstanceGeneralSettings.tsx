  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            <h2 className="text-sm font-semibold">{t("instanceGeneral.keyboardShortcuts")}</h2>
            <p className="max-w-2xl text-sm text-muted-foreground">
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="space-y-5">
          <div className="space-y-1.5">
            <h2 className="text-sm font-semibold">{t("instanceGeneral.backupRetention")}</h2>
            <p className="max-w-2xl text-sm text-muted-foreground">
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="space-y-4">
          <div className="space-y-1.5">
            <h2 className="text-sm font-semibold">{t("instanceGeneral.aiFeedbackSharing")}</h2>
            <p className="max-w-2xl text-sm text-muted-foreground">
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          >
            ...
            {signOutMutation.isPending ? t("instanceGeneral.signingOut") : t("instanceGeneral.signOut")}
          </Button>
        </div>
      </section>
    </div>
